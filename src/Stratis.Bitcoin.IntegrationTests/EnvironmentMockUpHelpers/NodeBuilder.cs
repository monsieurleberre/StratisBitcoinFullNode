...
namespace Stratis.Bitcoin.IntegrationTests.EnvironmentMockUpHelpers
{
    ...
    public class NodeBuilder : IDisposable
    {
        ...
        {
            var node = new CoreNode(new BitcoinCoreRunner(this.GetDataFolderName(nodeName), this.BitcoinD), this, Network.RegTest);
            this.Nodes.Add(node);
            if (start)
                node.Start();
            return node;
        ...
        {
            var node = new CoreNode(new StratisBitcoinPowRunner(this.GetDataFolderName(nodeName), callback), this, Network.RegTest);
            this.Nodes.Add(node);
            if (start)
                node.Start();
            return node;
        ...
        {
            var node = new CoreNode(new StratisProofOfWorkMiningNode(this.GetDataFolderName(nodeName), callback), this, Network.RegTest, configfile: "stratis.conf");
            this.Nodes.Add(node);
            if (start)
                node.Start();
            return node;
        ...
        {
            var node = new CoreNode(new StratisBitcoinPosRunner(this.GetDataFolderName(nodeName), callback), this, Network.RegTest, configfile: "stratis.conf");
            this.Nodes.Add(node);
            if (start)
                node.Start();
            return node;
        ...
        {
            var node = new CoreNode(new StratisPosApiRunner(this.GetDataFolderName(nodeName), callback), this, Network.RegTest, configfile: "stratis.conf");
            this.Nodes.Add(node);
            if (start)
                node.Start();
            return node;

...
{
    public abstract class SmashMain : Network
    {
        private const int pubKeyAddressByte = 41; //H
        private const int scriptAddressByte = 100; //h

        protected SmashMain(ConsensusFactory consensusFactory, Action<Block> customiseGenesisBlock)
        {
            this.Name = nameof(SmashMain);
            ...
            Block genesisBlock = GenesisBuilder.CreateBitcoinGenesisBlock(consensusFactory, 1296688602, 414098458, 0x1d00ffff, 1, Money.Coins(50m), customiseGenesisBlock);

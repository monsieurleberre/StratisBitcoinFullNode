...
{
    public abstract class SmashPosTest : Network
    {
        private const int pubKeyAddressByte = 43; //J
        private const int scriptAddressByte = 105; //j

        protected SmashPosTest(ConsensusFactory consensusFactory, Action<Block> customiseGenesisBlock)
        {
            this.Name = nameof(SmashPosTest);
            ...
            Block genesis = GenesisBuilder.CreateSmashGenesis(consensusFactory, 1296688602, 414098458, 0x1d00ffff, 4, Money.Coins(50m), customiseGenesisBlock);

...
{
    public abstract class SmashRegTest : Network
    {
        ...
        /// </summary>
        protected SmashRegTest(ConsensusFactory consensusFactory, Action<Block> customiseGenesisBlock)
        {
            this.Name = nameof(SmashRegTest);
            ...
            Block genesisBlock = GenesisBuilder.CreateBitcoinGenesisBlock(consensusFactory, 1296688602, 2, 0x207fffff, 1, Money.Coins(50m), customiseGenesisBlock);

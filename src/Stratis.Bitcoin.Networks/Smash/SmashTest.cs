...
{
    public abstract class SmashTest : Network
    {
        private const int pubKeyAddressByte = 43; //J
        private const int scriptAddressByte = 105; //j

        protected SmashTest(ConsensusFactory consensusFactory, Action<Block> customiseGenesisBlock)
        {
            this.Name = nameof(SmashTest);
